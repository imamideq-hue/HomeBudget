...
/** `Animated.View` with `className` support — use with `entering` for fade-ins. */
...
/**
 * A drop-in Pressable replacement that springs down slightly while pressed for
 * tactile feedback. Layout/`className` behave exactly like a normal Pressable.
 */
